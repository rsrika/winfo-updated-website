...
export function HackathonFAQ(props) {
  ...
  <div id='hackathon-faq' >
    <h2 className='purple title'>Frequently Asked Questions</h2>
    <div className='container'>
      <div className='row'>
        ...
        <div className='col'>
          ...
          <br/>
          <p className='question'>Can we network with the mentors/sponsors?</p>
          <p className='answer'>Yes! Mentors are here to assist you in your project and give any advice. Sponsors would love to get to know you and hear what you’re working on. Large companies love sponsoring Winfo’s Hackathon because of talented and passionate students like yourself!</p>
          <br/>
