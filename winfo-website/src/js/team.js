...
export function Team(props) {
    ...
    const teamMembers = [
        ...
        { year: "2022-2023", name: 'Melina Perraut', position: 'Co-President', imageUrl: 'public/img/Officers/Officers/2022_Officers/' },
        { year: "2022-2023", name: 'Roshni Srikanth', position: 'Co-President', imageUrl: 'public/img/Officers/Officers/2022_Officers/' },
        { year: "2022-2023", name: 'Bhavya Garlapati', position: 'Director of Finance', imageUrl: 'public/img/Officers/Officers/2022_Officers/' },
        { year: "2022-2023", name: 'Lucy Lin', position: 'Director of Outreach', imageUrl: 'public/img/Officers/Officers/2022_Officers/' },
        { year: "2022-2023", name: 'Kelly Wang', position: 'Creative Director', imageUrl: 'public/img/Officers/Officers/2022_Officers/' },
        { year: "2022-2023", name: 'Alyssa Vo', position: 'Director of Public Relations', imageUrl: 'public/img/Officers/Officers/2022_Officers/' },
        { year: "2022-2023", name: 'Bandhna Bedi', position: 'Director of Diversity Efforts', imageUrl: 'public/img/Officers/Officers/2022_Officers/' },
        { year: "2022-2023", name: 'Kayla Tounalom', position: 'Director of Community Efforts', imageUrl: 'public/img/Officers/Officers/2022_Officers/' },
        { year: "2022-2023", name: 'Emiri Nishizawa', position: 'Hackathon Director', imageUrl: 'public/img/Officers/Officers/2022_Officers/' },
    
        { year: "2021-2022", name: 'Allison Geary', position: 'Co-President', imageUrl: 'public/img/Officers/Officers/2021_Officers/' },
        { year: "2021-2022", name: 'Kayla Chea', position: 'Co-President', imageUrl: 'public/img/Officers/Officers/2021_Officers/' },
        { year: "2021-2022", name: 'Rachel Kinkley', position: 'Director of Finance', imageUrl: 'public/img/Officers/Officers/2021_Officers/' },
        { year: "2021-2022", name: 'Melina Perraut', position: 'Director of Outreach', imageUrl: 'public/img/Officers/Officers/2021_Officers/' },
        { year: "2021-2022", name: 'Dana Rin', position: 'Creative Director', imageUrl: 'public/img/Officers/Officers/2021_Officers/' },
        { year: "2021-2022", name: 'Sam Rondini', position: 'Director of Public Relations', imageUrl: 'public/img/Officers/Officers/2021_Officers/' },
        { year: "2021-2022", name: 'Roshni Srikanth', position: 'Director of Diversity Efforts', imageUrl: 'public/img/Officers/Officers/2021_Officers/' },
        { year: "2021-2022", name: 'Gisele Fox', position: 'Director of Community Efforts', imageUrl: 'public/img/Officers/Officers/2021_Officers/' },
        { year: "2021-2022", name: 'Sharon Lin', position: 'Hackathon Director', imageUrl: 'public/img/Officers/Officers/2021_Officers/' },
